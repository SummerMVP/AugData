...
class ReparameterizationNoise(nn.Module):
    def __init__(self, tau=0.1):
        super(ReparameterizationNoise, self).__init__()
        self.tau = tau
    ...
    def forward(self, p1):
        ...
        sampled_noise = torch.sigmoid((p1 + noise * self.tau))


        sampled_noise = (sampled_noise - 0.5) * 2
